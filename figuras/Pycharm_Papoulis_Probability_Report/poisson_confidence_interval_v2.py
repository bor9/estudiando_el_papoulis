...
plane_front = np.where((ll - xx) ** 2 - A * ll < 0, plane, np.nan)
...
# plano
surf_font = ax.plot_surface(xx, ll, plane_front, alpha=alpha, cmap=cm.autumn, linewidth=0, antialiased=True,
                            rstride=10, cstride=10, zorder=10,
